...
?>
                            ...
                            <div class="order-details">
                                ...
                                <?php if ($order['raw_status'] == 2 && !empty($order['tracking'])): ?>
                                    <button type="button" class="btn btn-outline-primary ms-2"
                                            onclick="trackOrder('<?php echo $order['tracking']; ?>')">
        ...
        <div class="order-details-container">
            ...
            ${order.raw_status == 2 && order.tracking ? `
                <div class="mt-4 p-3 bg-light rounded">
                    ...
                    <button type="button" class="btn btn-outline-primary" onclick="trackOrder('${order.tracking}')">
                        <i class="bi bi-truck"></i> Traccia Spedizione
                    </button>
                </div>
            ` : ''}
    ...
    `;
        ...
        function trackOrder(tracking) {
            // Implementa qui la logica per il tracking
            alert('Tracking: ' + tracking + '\\n\\nQui puoi implementare l\\'integrazione con il corriere.');
        }
