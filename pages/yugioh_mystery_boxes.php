...
function getImagePathById($itemId, $itemType, $conn) {
    if ($itemType === 'funko_pop') {
        ...
        return BASE_URL . '/images/mystery_box_yugioh.webp'; // Tipo non supportato
    }
    ...
    if ($stmt === false) {
        ...
        return BASE_URL . '/images/mystery_box_yugioh.webp';
    }
...
// Query per recuperare le Mystery Box YuGiOh!
...
<main class="background-custom">
    <div class="container">
        <h1 class="fashion_taital mb-5">Mystery Box Yu-Gi-Oh!</h1>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <form action="<?php echo BASE_URL; ?>/action/add_to_cart.php" method="POST">
                                        ...
                                        <input type="hidden" name="redirect_url" value="<?php echo BASE_URL; ?>/pages/yugioh_mystery_boxes.php">
