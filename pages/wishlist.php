...
// Query per recuperare gli items nella wishlist
$query = "
    SELECT 
        w.id_wishlist,
        w.data_aggiunta,
        ...
        CASE 
            ...
            ELSE 'box'
        END as tipo,
        i.nome_img as immagine
    FROM wishlist w
    LEFT JOIN oggetto o ON w.fk_oggetto = o.id_oggetto
    LEFT JOIN mystery_box mb ON w.fk_box = mb.id_box
    LEFT JOIN immagine i ON (o.nome_oggetto = i.nome_img OR  mb.nome_box= i.nome_img)
    WHERE w.fk_utente = ?
                        ...
                        <?php foreach ($wishlist_items as $item): ?>
                            <div class="wishlist-item-card" data-wishlist-id="<?php echo $item['id_wishlist']; ?>">
                                ...
                                <div class="wishlist-item-details">
                                    ...
                                    <p class="description"><?php echo htmlspecialchars(substr($item['descrizione'], 0, 100)) . '...'; ?></p>
