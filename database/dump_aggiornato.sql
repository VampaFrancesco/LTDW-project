...
--
-- Host: 127.0.0.1
-- Creato il: Ago 03, 2025 alle 23:40
...
INSERT INTO `oggetto` (`id_oggetto`, `nome_oggetto`, `desc_oggetto`, `fk_categoria_oggetto`, `fk_rarita`) VALUES
(1, 'Mago Nero', 'Mostro di tipo Incantesimo', 1, 3),
(2, 'Pikachu', 'Pokémon di tipo Elettro', 2, 1);
...
--
ALTER TABLE `oggetto`
  MODIFY `id_oggetto` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
