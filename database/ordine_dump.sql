...
--
-- Host: localhost:8889
-- Creato il: Ago 05, 2025 alle 14:05
...
INSERT INTO `carrello` (`id_carrello`, `totale`, `fk_utente`, `data_creazione`, `quantita`, `fk_mystery_box`, `fk_oggetto`) VALUES
(1, 50, 1, '2025-08-05 16:03:40', 2, 1, 1);
...
INSERT INTO `immagine` (`id_immagine`, `nome_img`, `descrizione_img`, `dimensione`, `fk_oggetto`) VALUES
(1, 'mago_nero.jpg', NULL, NULL, 1),
(2, 'plancia_arancione.png', NULL, NULL, 3);
...
INSERT INTO `mystery_box` (`id_box`, `nome_box`, `desc_box`, `prezzo_box`, `quantita_box`) VALUES
(1, 'YugiBox - RARA', 'Mystery Box RARA personalizzata dal team di BOXOMNIA', 25, 5);
...
INSERT INTO `oggetto` (`id_oggetto`, `nome_oggetto`, `desc_oggetto`, `prezzo_oggetto`, `fk_categoria_oggetto`, `fk_rarita`) VALUES
(1, 'Mago Nero', 'Mostro di tipo Incantesimo', NULL, 1, 3),
(2, 'Pikachu', 'Pokémon di tipo Elettro', NULL, 2, 1),
(3, 'Plancia di gioco', 'Colore: arancione', 15, 4, NULL);
...
(1, '2025-08-05 16:04:12', '7e77e', 1, 1, 1, 1);
...
(2, 'Francesco', 'Vampa', 'fv@gmail.com', '$2y$10$NXPIRLr5x50X6Do73ySyNuX/JkeMiGkfM2r24MPkovCvCV64WfRWi');
...
--
ALTER TABLE `carrello`
  MODIFY `id_carrello` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `immagine`
  MODIFY `id_immagine` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `mystery_box`
  MODIFY `id_box` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `utente`
  MODIFY `id_utente` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
