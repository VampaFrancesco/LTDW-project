...
--
-- Host: 127.0.0.1
-- Creato il: Ago 04, 2025 alle 23:53
...
--
ALTER TABLE `oggetto`
  MODIFY `id_oggetto` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT per la tabella `oggetto_collezione`
--
ALTER TABLE `oggetto_collezione`
  MODIFY `fk_oggetto` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `rarita`
  MODIFY `id_rarita` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
